...
import { mamdaniInference, mamdaniInferenceSeparate } from './utils';
...
export class FuzzyInferenceSystem
{
  ...
  solveSeparate = (args: Record<string, number>, defuzzicationMethod: DefuzzicationType): Record<string, number> =>
  {
    return mamdaniInferenceSeparate(this.inputs, this.outputs, this.rules, args, defuzzicationMethod);
  };
}
